  ...
  return (
    <div className="flex min-h-[480px] max-h-[480px] max-md:min-h-[320px]">
      ...
      <div className="for-fix-image w-[50%] max-md:w-full">
        <ImageCarousel
          className="rounded-l-[16px] w-full h-full object-cover max-md:rounded-[16px] border border-[#EEEEEE] overflow-hidden"
          url={storageImages[0]}
      ...
      <div className="for-fix-image w-[25%] mx-[12px] max-lg:mr-[0] flex flex-col gap-[12px] max-lg:w-[50%] max-lg:ml-[12px] max-md:hidden">
        <ImageCarousel
          className="w-full h-full object-cover max-lg:min-h-[49%] border border-[#EEEEEE] overflow-hidden"
          url={storageImages[1]}
      ...
      <div className="for-fix-image for-fix-image w-[25%] flex flex-col gap-[12px] max-lg:hidden">
        {storageImages[3] && (
          <ImageCarousel
            className="w-full h-full rounded-tr-[16px] object-cover border border-[#EEEEEE] overflow-hidden"
            url={storageImages[3]}
        ...
        {storageImages[4] && (
          <ImageCarousel
            className="w-full h-full rounded-br-[16px] object-cover border border-[#EEEEEE] overflow-hidden"
            url={storageImages[4]}
