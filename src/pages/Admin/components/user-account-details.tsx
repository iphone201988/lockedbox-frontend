...
import { useGetUserDetailsQuery } from "../../../redux/api/admin";
import Loader from "../../../components/Loader";
import { useEffect } from "react";

const UserAccountDetails = () => {
  const { id } = useParams();
  const { data, isLoading } = useGetUserDetailsQuery(id || "", { skip: !id });
        ...
        <div className=" max-w-[400px] w-full max-md:max-w-full">
          <div className="">
            ...
            <div className=" flex flex-col gap-[10px] mt-[10px]">
              ...
              <p className=" font-semibold">
                User ID:{" "}
                <span className=" font-normal text-[#959595]">123456789</span>
              </p>
              <p className=" font-semibold">
                Email:{" "}
                <span className=" font-normal text-[#959595]">
              ...
              <p className=" font-semibold">
                Account creation:{" "}
                <span className=" font-normal text-[#959595]">11/04/2022</span>
              </p>
            </div>
          </div>
        </div>
